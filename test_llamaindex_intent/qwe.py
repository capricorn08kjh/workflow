...
1. document_search: 문서/보고서/회의록 등에서 정보를 찾아야 하는 질의
1. hybrid: 정형 데이터와 문서 검색이 모두 필요한 질의
1. general_query: 일반적인 질문이나 대화
...
1. search_documents: 회의록, 보고서 등 문서에서 정보 검색
1. create_visualization: 데이터를 차트로 시각화
1. hybrid_analysis: 정형 데이터와 문서를 함께 분석
